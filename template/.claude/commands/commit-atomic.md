...
allowed-tools: Bash(git:*), Bash(npm:*), Read, Glob, Grep, AskUserQuestion
---
...
Before committing, run quality checks based on what files are being committed (linting, formatting, type checking, etc.).
